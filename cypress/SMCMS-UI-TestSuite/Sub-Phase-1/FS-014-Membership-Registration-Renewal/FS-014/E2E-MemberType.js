...
describe('[TS05] Member Type Management', function (){
    ...
    it('[TC01] Create New Member Type', function (){
            ...
            MemTypeDtl.VerifyNotificationMsg('Record has been saved successfully.')
        })

    it('[TC02] Validate newly created Member Type in the List', function (){

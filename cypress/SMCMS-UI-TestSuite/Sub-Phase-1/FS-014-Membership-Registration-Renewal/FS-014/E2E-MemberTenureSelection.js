...
const MemshipTenureSelection = () => {


describe('[TS07] Membership Tenure Selection Form', function () {

    // Page Definitions
    const MemTenureSelect = new MembershipTenureSelection()

    it('[TC01] Edit Membership Tenure Selection Form ', function () {
...
export default MemshipTenureSelection
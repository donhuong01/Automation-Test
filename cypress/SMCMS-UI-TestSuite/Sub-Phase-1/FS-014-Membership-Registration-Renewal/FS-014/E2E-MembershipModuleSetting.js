...
describe('[TS09] Membershp Module Setting',function(){

    const MemModuleSetting =  new MembershipModuleSetting()

    it('[TC01] Update Membership Module Setting Form', function(){
    ...
    it('[TC02] Update Membership Module Setting Form and Cancel', function(){
...
export default MembershipModuleSettings
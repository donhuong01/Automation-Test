...
describe('Facility Type Detail Form', function () {
    ...
    it.skip('[TC01] FillOut Facility Type Detail form and click cancel button', function () {
        ...
        //Category Section
        FacilityTypeDetailForm.FillOutCategorySection('CORPORATE SQUASH', 'F & B Events', 'Activities by Clubs',
                                    'Family & Enrichment', 'Food & Entertainment-SMC', 'By officers manually');
        //Booking Restriction

...
const RenewalWith1PrincipalAndDependentSpouse = (SFS, MaritalStatus, MemberType, CustomerNRICFull, PrincipalTenure, Spouse, DepSouseNRICFull, DependentSpouseTenure) => {
    ...
    describe('[TS07] Member Registration Principal]', function () {
        ...
        const PrincipalEmail = Customerdata.CustomerCreationPrincipal.ContactInformation.emailAddress + UserID + "wey" + "@test.com"
        ...
        const DepChildEmail = Customerdata.CustomerCreationDependentChild.ContactInformation.emailAddress + UserIDDep + "wrz" + "@test.com"
        ...
        const DepSouseEmail = Customerdata.CustomerCreationDependentSpouse.ContactInformation.emailAddress + UserIDSpouse + 'jwh' + "@test.com"
...
export default RenewalWith1PrincipalAndDependentSpouse
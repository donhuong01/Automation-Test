...
const RegistrationWith1Principal = (SFS, MaritalStatus, MemberType, CustomerNRICFull, PrincipalTenure) => {

    describe('[TS07] Registration with 1 principal ', function () {
...
export default RegistrationWith1Principal
...
const CustomerNRIC = '345C'
const CustomerNRICFull = 'S3774345C'
...
describe('[TS01] Membership Suspention Release Request Management',function(){
    ...
    it('[TC02] Creating a Membership Suspention Request', function(){
    ...
    it('[TC03] Creating a Membership Suspention Release(Early) Request', function(){

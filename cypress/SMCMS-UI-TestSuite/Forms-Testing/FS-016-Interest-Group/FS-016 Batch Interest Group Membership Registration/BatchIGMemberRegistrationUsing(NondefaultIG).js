...
describe('FS-016 Batch Interest Group Membership Registration', function () {
    ...
    data.forEach(item => {
        ...
        const { MemberId, BatchName, BatchType, InterestGroupMain, InterestGroup, EffectiveDate, IGMembershipTerm, InterestGroupLocation } = item

        it('Creating a Batch Membership Registration using Non Default IG', function () {

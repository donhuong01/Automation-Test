...
import Bdata from '../../../../fixtures/Data_Module/FS-016-Interest-Group/BatchIGRegistrationNewCustomerUsing(defaultIG)'
...
describe('FS-016 Batch Interest Group Membership Registration', function () {
    ...
    Bdata.forEach(item => {
        ...
        const { NRICLast4Digit, CustomerNRICFull, BatchName, BatchType, InterestGroup, EffectiveDate, IGMembershipTerm, InterestGroupLocation } = item
        ...
        it('Creating a Batch Membership Registration for New Customer using Default IG', function () {

...
const { MemberId, BatchName, BatchType, InterestGroup, EffectiveDate, IGMembershipTerm, InterestGroupLocation } = data
...
describe('FS-016 Batch Interest Group Membership Registration', function () {
    ...
    it('Creating a Batch Membership Registration with Existing Membership using Non Default IG', function () {
        ...
        IGMembershipRegistration.ClickOnBox('Badminton Social Group')

        IGMembershipRegistration.ClickOnBox('BITEZ')

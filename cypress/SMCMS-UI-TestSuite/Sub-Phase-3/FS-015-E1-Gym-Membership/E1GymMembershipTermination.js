...
import E1GymRegData from '../../../fixtures/Data_Module/FS-015-E1-Gym-Membership/FS-015-E1-Gym-Membership-Registration'
...
const CustomerNRIC = Customerdata.CustomerCreationPrincipal.RegistrationInformation.NRICLAST4DIGIT
...
describe('FS-015 E1 GYM Membership Registration', function () {
    ...
    it('E1 GYM Member Registration for Non-Existing SAFRA member', function () {
        ...
        E1GymMembershipRegistration.SelectDepandencyType(E1GymRegData.DependencyType)

        E1GymMembershipRegistration.MembershipInfo(E1GymRegData.EffectiveDate)

        // E1GymMembershipRegistration.OtherInfoCheckboxes(E1GymRegData.TermCondition, E1GymRegData.Indemnity)

        E1GymMembershipRegistration.AddWiaver(E1GymRegData.ChargeType, E1GymRegData.Amount, E1GymRegData.WiaverReason)

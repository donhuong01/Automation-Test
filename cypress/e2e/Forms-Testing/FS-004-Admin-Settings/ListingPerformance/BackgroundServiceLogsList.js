const BakcgroundServiceLogsList = () => {
    it('Bakcground Service Logs List', function () {
        const t0 = performance.now(); // Set t0 before the cy.visit
        cy.visit('/admin/backgroundserviceslogsList');
...
export default BakcgroundServiceLogsList

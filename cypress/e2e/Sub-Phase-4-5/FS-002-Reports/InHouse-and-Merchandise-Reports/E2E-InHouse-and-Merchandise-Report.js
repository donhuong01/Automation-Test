...
const InHouseMerchandise_Report = () => {
    ...
    describe("InHouse and Merchandise Reports Access Checking",function(){

        it('Checking Access on Counter Receipt Collection Listing', function(){
        ...
        it('Checking Access on In-House Revenue Sale Listing', function(){
        ...
        // it('Checking Access on In-House Revenue Sale Email Listing', function(){
        ...
        // it('Checking Access on In-House Revenue Sale Mobile Listing', function(){
        ...
        it('Checking Access on Merchanduse Revenue Sale Listing', function(){
        ...
        it('Checking Access on Merchanduse Revenue Sale By Period Listing Listing', function(){
        ...
        it('Checking Access on Merchanduse Revenue Sale By Total Payment Collected Listing', function(){
        ...
        it('Checking Access on Merchanduse Revenue Sale Item Listing', function(){

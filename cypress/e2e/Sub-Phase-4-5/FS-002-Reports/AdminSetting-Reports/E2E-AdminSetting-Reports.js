...
const AdminSetting_Report = () => {
    ...
    describe("Admin Settings Verification",function(){
        ...
        it('Checking Verification on Collected Redeemed Stock Listing', function(){
        ...
        it('Checking Verification on Approval Process', function(){
        ...
        it('Checking Verification on Locked User Account Log', function(){
        ...
        it('Checking Verification on Reassigned Task', function(){
        ...
        it('Checking Verification on System Login Log', function(){
        ...
        it('Checking Verification on User Account Listing Report', function(){
        ...
        it('Checking Verification on User Assigned Dashboard', function(){
        ...
        it('Checking Verification on User Assigned Location', function(){
        ...
        it('Checking Verification on User Assigned Report', function(){
        ...
        it('Checking Verification on User Assigned Roles Position', function(){
        ...
        it('Checking Verification on User Functional Access', function(){

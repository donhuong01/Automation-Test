...
const MembershipPrincipalRegistration = (CustomerNRICFull, DepChildNRICFull, DepSouseNRICFull) => {



    describe('[TS07] Full Member Registration]', function () {
        ...
        it('[TC01] Customer Creation and SFS Principal Registration with Child and Spouse', function () {
            ...
            CustomerCreation.fillOutContactInformation({
                ...
                preferredContactModeWhatsApp: data.CustomerCreationPrincipal.ContactInformation.preferredContactModeWhatsApp,
            ...
            CustomerCreation.fillOutInterestAreaInformation({
                ...
                clubChoa: data.CustomerCreationPrincipal.InterestAreaInformation.clubChoa,
            ...
            MemRegPrincipal.verifyPreferredContactMode({
                ...
                // Preferred Contact Mode
                SelectAll: data.CustomerCreationPrincipal.ContactInformation.preferredContactModeSelectAll,
                Email: data.CustomerCreationPrincipal.ContactInformation.preferredContactModeEmail,
                Mail: data.CustomerCreationPrincipal.ContactInformation.preferredContactModeMail,
                SMS: data.CustomerCreationPrincipal.ContactInformation.preferredContactModeSMS,
                VoiceCall: data.CustomerCreationPrincipal.ContactInformation.preferredContactModeVoiceCall,
                PushNotification: data.CustomerCreationPrincipal.ContactInformation.preferredContactModePushNotification,
                WhatsApp: data.CustomerCreationPrincipal.ContactInformation.preferredContactModeWhatsApp,
            ...
            //     //Consent Information
            //     MarketingConsent: data.CustomerCreationPrincipal.ContactInformation.consentInformationMarketing,
            //     consentInformationServiceNotification: data.CustomerCreationPrincipal.ContactInformation.consentInformationServiceNotification,
            //     consentInformationTransactional: data.CustomerCreationPrincipal.ContactInformation.consentInformationTransactional,
            ...
            MemRegPrincipal.verifyPreferredSafraClubs({
                ...
                //Preferred SAFRA clubs
                safraChoa: data.CustomerCreationPrincipal.InterestAreaInformation.clubChoa,
                safraJurong: data.CustomerCreationPrincipal.InterestAreaInformation.clubJurong,
                safraPunggol: data.CustomerCreationPrincipal.InterestAreaInformation.clubPunggol,
                safraToaPayoh: data.CustomerCreationPrincipal.InterestAreaInformation.clubPayoh,
                safraMtFaber: data.CustomerCreationPrincipal.InterestAreaInformation.clubFaber,
                safraTampines: data.CustomerCreationPrincipal.InterestAreaInformation.clubTampines,
                safraYishun: data.CustomerCreationPrincipal.InterestAreaInformation.clubYishun,
            ...
            MemRegPrincipal.verifySafraBrands({
                ...
                //SAFRA Brands
                energyOneGym: data.CustomerCreationPrincipal.InterestAreaInformation.brandEnergyOneGym,
                kidzAmazeSplshIndrPlayGrnd: data.CustomerCreationPrincipal.InterestAreaInformation.brandKidzAmaza,
                finsSwimSchool: data.CustomerCreationPrincipal.InterestAreaInformation.brandFINS,
            ...
            MemRegPrincipal.verifyIamInterestedIn({
                ...
                //I am interested in
                allEventsAndActivities: data.CustomerCreationPrincipal.InterestAreaInformation.interestedAllEvents,
                allPeaksAndPromos: data.CustomerCreationPrincipal.InterestAreaInformation.interestedAllPeaks,
                fitnessAndAdventure: data.CustomerCreationPrincipal.InterestAreaInformation.interestedFitness,
                childEnrichmentActivities: data.CustomerCreationPrincipal.InterestAreaInformation.interestedChild,
                lifeLongLearning: data.CustomerCreationPrincipal.InterestAreaInformation.interestedLifelong,
                leisureAndEntrtnmnt: data.CustomerCreationPrincipal.InterestAreaInformation.interestedLeisure,
                foodAndBeverages: data.CustomerCreationPrincipal.InterestAreaInformation.interestedFood,
                shoppingAndGroceries: data.CustomerCreationPrincipal.InterestAreaInformation.interestedShopping,
                travel: data.CustomerCreationPrincipal.InterestAreaInformation.interestedTravel,
                motoring: data.CustomerCreationPrincipal.InterestAreaInformation.interestedMotoring,
                healthAndBeauty: data.CustomerCreationPrincipal.InterestAreaInformation.interestedHealth,
                safraPtsRewardsProgramme: data.CustomerCreationPrincipal.InterestAreaInformation.interestedSAFRAPOINTS,
                //SAFRA Newsletter
                ensman: data.CustomerCreationPrincipal.InterestAreaInformation.SAFRANewsletter,
            })

            MemRegPrincipal.verifyInterestGrpsAndMicroClubs({

                //Interest Groups & Micro Clubs
                safraAdventureClub: data.CustomerCreationPrincipal.InterestAreaInformation.groupAdventure,
                bitezFandB: data.CustomerCreationPrincipal.InterestAreaInformation.groupBitez,
                safraCommSrvcsClub: data.CustomerCreationPrincipal.InterestAreaInformation.groupCommService,
                safraCompSportsClub: data.CustomerCreationPrincipal.InterestAreaInformation.groupCompetitive,
                safraDigitalMediaClub:data.CustomerCreationPrincipal.InterestAreaInformation.groupDigimedia,
                safraEntrpnrsClub: data.CustomerCreationPrincipal.InterestAreaInformation.groupEntrep,
                fuseEntrtnmnt: data.CustomerCreationPrincipal.InterestAreaInformation.groupFuse,
                safraGolfingSection: data.CustomerCreationPrincipal.InterestAreaInformation.groupGolf,
                safraMovieMax: data.CustomerCreationPrincipal.InterestAreaInformation.groupMovie,
                safraPhotoClub: data.CustomerCreationPrincipal.InterestAreaInformation.groupPhotograph,
                safraRunningClub: data.CustomerCreationPrincipal.InterestAreaInformation.groupRunning,
                safraShootingClub: data.CustomerCreationPrincipal.InterestAreaInformation.groupShooting,
                safraSocialBadmntnClub: data.CustomerCreationPrincipal.InterestAreaInformation.groupSocialBadminton,
                safraTechClub: data.CustomerCreationPrincipal.InterestAreaInformation.groupTech,
                safraTravelClub: data.CustomerCreationPrincipal.InterestAreaInformation.groupTravel
            })
...
export default MembershipPrincipalRegistration

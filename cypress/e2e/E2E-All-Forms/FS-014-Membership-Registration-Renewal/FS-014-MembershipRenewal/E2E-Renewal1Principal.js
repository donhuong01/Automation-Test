...
import { RenewalWith1Principle } from '../../../../fixtures/Data_Module/FS-014-Membership-Registration-Renewal/014-MembershipRenewalWithDiffrtMemTyp'
...
RenewalWith1Principle.forEach(data => {
    ...
    describe(`E2E Auto Testing:FS-014: ${data.MemberType} Principal Registration and Renewal`, () => {

...
import { RenewalWith1PrincipleAnd1DependentSpouse } from '../../../../fixtures/Data_Module/FS-014-Membership-Registration-Renewal/014-MembershipRenewalWithDiffrtMemTyp'
beforeEach(() => {
...
RenewalWith1PrincipleAnd1DependentSpouse.forEach(data => {
    ...
    describe(`E2E Auto Testing:FS-014: ${data.MemberType} Principal Member Registration & Renewal with 1 Dependent Spouse`, () => {

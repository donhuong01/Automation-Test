...
import { SFSRegistrationWith1Principle } from '../../../../fixtures/Data_Module/FS-027-Membership-SFS/027-SFS-MembershipRegisterationWithDiffrtMemType'
...
SFSRegistrationWith1Principle.forEach(data => {
    ...
    describe(`E2E Auto Testing:FS-014: ${data.MemberType} Principal Member Registration`, () => {

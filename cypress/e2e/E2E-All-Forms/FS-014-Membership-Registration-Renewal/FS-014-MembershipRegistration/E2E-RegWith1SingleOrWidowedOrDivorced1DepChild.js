...
import { RegistrationWithSingleOrWidwedOrDevorcedPrinciplAnd1Dep } from '../../../../fixtures/Data_Module/FS-014-Membership-Registration-Renewal/014-MembershipRegisterationWithDiffrtMemType'
...
RegistrationWithSingleOrWidwedOrDevorcedPrinciplAnd1Dep.forEach(data => {
    ...
    describe(`E2E Auto Testing:FS-014:${data.MaritalStatus} Principal Member Registration with Dependent Child`, () => {

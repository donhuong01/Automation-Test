const data = {
        ...
        templateCodes: [
            {
                ...
                subject: 'Resignation Request has been submitted (ID:[[folioid]])',
    ...
    AnnouncementPortalNotificationListing: {
        ...
        announcePortalNotifList: [
            {
                title: 'Notif 2022',
                publishDate: '18-May-2022 03:57 AM',
                expiryDate: '01-Jan-0001 04:28 AM',
                status: 'Active'
            }
        ],
    ...
    DocumentTemplateListing: {

        Filters: {
            templateName: 'Sample Test',
            status: 'Active'
        },
        ...
        documentTemplateList: [
            ...
            // {
            //     templateName : 'Template Try',
            //     status : 'AdminSettingDocumentTemplate'
            // }
        ],

        templateNameLink: 'Sample Test',
        downloadLink: 'Update Test',
        templateItem: 'Update Test',
    },
    ...
    // Document Template Detail
    UpdatedDocumentTemplateDetail: {
        TemplateName: 'Update Test',
        TemplateCode: 'TE',
        Status: 'Enabled',
        TemplateDocument: 'Template.doc',
        Remark: 'Updated Trial'
    }

...
const SFSBatchMembershipRegistrationWithExistingMembers = [
...
const NonSFSBatchMembershipRegistrationWithExistingMembers = [

    {
        SFS: 'SFS Disable',                     // To disable SFS type 'SFS Disable'
        MaritalStatus: 'Married',               // Enter Marital Status
        MemberType: 'AS',                       // Enter Member Type      
        CustomerNRICFull: 'S9419056H',          // Enter Nric
        PrincipalTenure: '10 Years',            // Membership Tenure 
        BatchTenure: '5 Years',                 // Batch MemberShip Tenure
        Dependent: 'YES',                       // If want to Add Child Pass YES else Pass NO
        DepChildNRICFull: 'S7046359H',          // Chid NRIC
        DependentChildTenure: '10 Years',       // Child Tenure 
        Spouse: 'NO',                           // If want to Add Spouse Pass YES else Pass NO
        DepSouseNRICFull: 'S5340313A',          // Spouse Nric
        DependentSpouseTenure: '10 Years'       // Spouse Tenure
    },
    // {
    //     SFS: 'SFS Disable',                    // To disable SFS type 'SFS Disable'
...
export { SFSBatchMembershipRegistrationWithExistingMembers, NonSFSBatchMembershipRegistrationWithExistingMembers }
const data = {
    ...
    checkin_email:{
        type: 'EMAIL',    
        value1:'TestUser[DoNotUse1]@gmail.com',
        },
    checkin_mobile:{
        type: 'MOBILENUMBER',    
        value1:'6547621111',
    ...
    checkin_scancard:{
        type: 'SCANECARD',    
        value1:'A30000128_3DA4F788839DE16D26F7865886038183AECEF073A605371439FCA067A95E8F15',
        },
    checkin_swipecard:{
        type: 'SWIPECARD',    
        value1:'%A8008980001869402^LEE CHOON CHIEH ^2508^A30000128^019801221000000?;8008980001869402=2508201000005500011?',
        },
...
//Member Registration Principal
    ...
    memberregistrationprincipal:{
        ...
        ContactInfo:{
            Handphone: '87126534',
            EmailAddress:   'auto'+ Math.floor(Math.random() * 100 * 50) +'@synergyonline.com',
            HomeNumber: 'NA',
    ...
    memregdependent:{
        ...
        ContactInfo:{
            Handphone: '87126534',
            EmailAddress: 'juandelacruz@synergyonline.com',
            HomeNumber: 'NA',
            EmergencyContact:'+65 658 5894', 
            //Preferred COntact Mode
            SelectAll: 'uncheck',
...
sourceChannelDetail:{
    userList: {
        username: 'Tran Hung',
        emailAddress: 'HTran@synergyonline.com'
    },

    addUser:'HTran@synergyonline.com',
    removeUser:'HTran@synergyonline.com',
...
MassUpdateForMemberDataListing : {
    batchId : 'MS-BR-100030', // 'MS-BR-100019' 
    batchIdItem : 'MS-BR-100016',
    massUpdForMemData : [
        {

class elems_MerchandiseItemChargeSetup {
    ...
    //General information
    static LBL_INHOUSESALEITEMID = '//label[text()="Merchandise ID"]//following-sibling::div//label'
    ...
    static TXT_UNITPERSET = '//input[@id="txtUnitsPerSet"]'
    static TXT_PRODUCTLIMITPERMEMBER = '//input[@id="txtPurchaseLimitPerMember"]'
...
export default elems_MerchandiseItemChargeSetup
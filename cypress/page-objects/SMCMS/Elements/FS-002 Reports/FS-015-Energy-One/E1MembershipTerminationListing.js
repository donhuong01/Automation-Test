class elems_E1MembershipTerminationListing {
    ...
    static TXT_TERMINATIONDATEFROM = '//input[@id="dtEnergyOneDateFrom"]'
    static TXT_TERMINATIONDATETO = '//input[@id="dtEnergyOneDateTo"]'
...
export default elems_E1MembershipTerminationListing
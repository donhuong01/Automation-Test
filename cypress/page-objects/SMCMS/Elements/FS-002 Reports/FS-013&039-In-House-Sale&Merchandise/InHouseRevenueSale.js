class elems_InHouseRevenueSale {
    static PCK_INHOUSEITEM = '//label[text()="In-House Sale Item Name"]//following-sibling::div//button'
...
export default elems_InHouseRevenueSale
class elems_InterestGroupMainDetail {
  ...
  static TabInterestGroup = {
    ...
    TXT_IGGROUPCATEGGROUP: '//label[text()="Interest Group Category Group"]/following-sibling::input',
  ...
  static TabChargeRate = {
    ...
    PCK_REGITEMCODE: '//label[text()="Registration Item Code"]/following-sibling::div//button',
    PCK_RENEWALITEMCODE: '//label[text()="Renewal Item Code"]/following-sibling::div//button',
    PCK_DEFERITEMCODE: '//label[text()="Deferment Item Code"]/following-sibling::div//button',
    PCK_REINSTATEMENTITEMCODE: '//label[text()="Reinstatement Item Code"]/following-sibling::div//button',
    PCK_TERMINATEITEMCODE: '//label[text()="Termination Item Code"]/following-sibling::div//button',
    PCK_WAIVERITEMCODE: '//label[text()="Waiver Item Code"]/following-sibling::div//button',
    PCK_REVERSALITEMCODE: '//label[text()="Reversal Item Code"]/following-sibling::div//button',

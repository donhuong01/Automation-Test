class elems_MembershipRegistrationDependentBatch {
    ...
    static PersonalInformation = {
        ...
        PCK_PRINCIPALID : '//label[@for="pckPrincipalId"]/parent::div//button',
        ...
        LBL_CARDTYPE : '//label[text()="Card Type"]',
        DRP_INTERESTINDBSCARD : '//span[@id="drpInterest"]',
        CHK_ALLOWTOREDEEMSAFRAPTS : '//input[@id="checkRedeem"]',

        ProfilePicture : {
            UPL_PROFILEPICTURE : '//label[@id="uplProfilePicture_label"]/parent::div//input[@type="file"]',
            UPL_CANCEL : '//label[@id="uplProfilePicture_label"]/parent::div//span[@title="Cancel"]/parent::button'
        }
    }
...
export default elems_MembershipRegistrationDependentBatch
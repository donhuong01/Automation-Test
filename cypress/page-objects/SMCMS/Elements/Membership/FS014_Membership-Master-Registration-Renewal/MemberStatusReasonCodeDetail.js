class elems_MemberStatusReasonCodeDetail{
    ...
    static DRP_COMEBACKERROR ='//div[@id="drpComeback"]'
    static TEXTAREA_REMARK = '//textarea[@id="remark"]'
    static TEXTAREA_REMARKERROR = '//div[@id="remark_error"]'

}
export default elems_MemberStatusReasonCodeDetail

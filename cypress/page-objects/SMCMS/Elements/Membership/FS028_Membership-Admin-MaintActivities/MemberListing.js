class elems_MemberListing {
    ...
    static BTNDRP_MEMBERSHIP = '//span[text()="Membership"]/parent::div//button[@class="k-button k-button-icon"]'
    static BTNDRP_SRP = '//span[text()="SRP"]/parent::div//button[@class="k-button k-button-icon"]'
    static BTNDRP_MAINTENANCE = '//span[text()="Maintenance"]//parent::button/following-sibling::button'//'//span[text()="Maintenance"]/parent::div//button[@class="k-button k-button-icon"]'
    static BTNDRP_PAYMENT = '//span[text()="Payment"]/parent::div//button[@class="k-button k-button-icon"]'

...
class Membership_Registration_Dependent {
    ...
    * @param {string} ProfilePicture ProfilePicture
    ...
    fillsoutPersonalInformation(
        ...
        CardType, InterestinDBSCard, AllowtoRedeemSAFRAPoints
    ) {
    ...
    *****************************************************/
    verifyAddressInformation({ IndependentAddress, PostalCode, Address, UnitNumber, PoBox, MyMailbox }) {   //Tick Checkbox IndependentAddress

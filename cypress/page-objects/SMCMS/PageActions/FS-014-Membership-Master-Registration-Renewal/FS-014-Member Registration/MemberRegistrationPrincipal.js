...
class MemberRegistrationPrincipal {
     ...
     *****************************************************/
    fillsoutPersonalInformation({ MemberCategory, NameOnNRIC, NameOnCard, Nric, Gender, DATE_DATEOFBIRTH, Age, NSStatus, NSRank, MemberType, Nationality, MaritalStatus, CardType, InterestinDBSCard, ProfilePicture
    }) {
...
export default MemberRegistrationPrincipal

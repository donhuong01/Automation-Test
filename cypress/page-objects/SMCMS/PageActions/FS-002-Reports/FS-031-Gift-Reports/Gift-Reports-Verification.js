...
verifyPendingCollection(expectedPg){
 ...
 /*****************************************************
    * Method: Checking functionallity and Verification on 
     ...
     * Description: This function verifies the page
*****************************************************/
verifyGiftCollection(expectedPg){
    cy.visit('/report?reportId=ReportMembershipGiftRedemption.GiftCollection')
    cy.wait(2000)
    cy.ValidateElementText(elems_CounterCollectionSettlement.LBL_PAGE, expectedPg)
 ...
 /*****************************************************
    * Method: Checking functionallity and Verification on 
              Gift Redemption Letter
     * Description: This function verifies the page
*****************************************************/
verifyGiftRedemptionLetter(expectedPg){
    cy.visit('/report?reportId=ReportMembershipGiftRedemption.GiftRedemptionLetter')
    cy.wait(2000)
    cy.ValidateElementText(elems_CounterCollectionSettlement.LBL_PAGE, expectedPg)
...
/*****************************************************
    * Method: Checking functionallity and Verification on 
              Gift Redemption Letter Address
     * Description: This function verifies the page
*****************************************************/
verifyGiftRedemptionLetterAddress(expectedPg){
    cy.visit('/report?reportId=ReportMembershipGiftRedemption.GiftRedemptionLetterAddress')
    cy.wait(2000)
    cy.ValidateElementText(elems_CounterCollectionSettlement.LBL_PAGE, expectedPg)
...
/*****************************************************
    * Method: Checking functionallity and Verification on 
              Transactions with Gift
     * Description: This function verifies the page
*****************************************************/
verifyTransactionsWithGift(expectedPg){
    cy.visit('/report?reportId=ReportMembershipGiftRedemption.TransactionsWithGift')
    cy.wait(2000)
    cy.ValidateElementText(elems_CounterCollectionSettlement.LBL_PAGE, expectedPg)

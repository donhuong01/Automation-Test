...
import elems_VIPMemberCardGeneration from '../../../Elements/Membership/FS030_Membership-Conversion-CardManagement/VipMemberCardGeneration'
import elems_MemberCard from '../../../Elements/Membership/FS030_Membership-Conversion-CardManagement/MemberCard'

class VIPMemberCardGeneration {
     ...
     *****************************************************/
    Generate(){
            cy.Click(elems_VIPMemberCardGeneration.BTN_GENERATE)
     ...
     *****************************************************/
    Cancel(){
            cy.Click(elems_VIPMemberCardGeneration.BTN_CANCEL)
...
export default VIPMemberCardGeneration